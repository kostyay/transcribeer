...
def test_list_sessions_empty(tmp_path):
    from transcribee.history_window import list_sessions
...
def test_audio_duration_missing(tmp_path):
    from transcribee.history_window import _audio_duration
